...
local credits = creds:section("Doors脚本",true)
 ...
 local creds = window:Tab("力量传奇",'16060333448')local credits
 creds:section("力量传奇脚本",true)    credits:Button("力量传奇",function()    loadstring(game:HttpGet('https://raw.githubusercontent.com/jynzl/main/main/Musclas%20Legenos.lua'))()end)
