...
local credits = creds:section("Doors脚本",true)
 ...
 local creds = window:Tab("力量传奇",'16060333448')local credits = creds:section("力量传奇脚本",true)    credits:Button("力量传奇",function()    loadstring(game:HttpGet('https://raw.githubusercontent.com/jynzl/main/main/Musclas%20Legenos.lua'))()end)
 ...
 CFrame.new(41.69497299194336, 3.6662418842315674, 408.0653991699219) end)
 credits:Button("金色宝箱", function()
 CFrame.new(-139.77784729003906, 3.6662497520446777, -278.7207946777344) end)
 credits:Button("冰霜宝箱", function()
 CFrame.new(-2573.37939453125, 3.6662492752075195, -550.3751831054688) end)
 creds:section("健身房传送",true)
 credits:Button("冰霜健身房(重生1)", function()
 CFrame.new(-2623.022216796875, 3.7162489891052246, -409.0733337402344) end)
