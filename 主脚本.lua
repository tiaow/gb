...
local credits = creds:section("内容",true)      
  ...
  spawn(function() while task.wait() do game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = Speed end end)
   ...
   credits:Slider("跳跃高度", "JumpPower", game.Players.LocalPlayer.Character.Humanoid.JumpPower, 50, 100000000, false, function(Jump)
...
local creds = window:Tab("被遗弃",'106133116600295')
local credits = creds:section("脚本",true)
credits:Button("汉化超好用", function()
loadstring(game:HttpGet("https://github.com/tiaow/gb/blob/main/%E6%96%B0%E6%96%B0%E8%A2%AB%E9%81%97%E5%BC%83.lua"))()
end)
