...
function Ripple(obj)
	spawn(function()
		...
		Ripple.ZIndex = 8
		Ripple.Image = "rbxassetid://112396419286940"
...
if theme == 'dark' then
    ...
    DTTransparency = 0.6
      ...
      DropShadow.Image = "rbxassetid://112396419286940"
      ...
      TabBtnsL.SortOrder = Enum.SortOrder.LayoutOrder = Enum.SortOrder.LayoutOrder
      ...
      function window.Tab(window, name, icon)
        ...
        function section:Label(text)
          ...
          function section.Keybind(section, text, default, callback)
            ...
            KeybindModule.Position =TextboxModule.Position = UDim2.new(0, 0, 0, 0)
